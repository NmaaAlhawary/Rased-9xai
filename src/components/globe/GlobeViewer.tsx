...
// Default camera: Amman, Jordan — high altitude overview
const DEFAULT_POSITION = Cartesian3.fromDegrees(35.9106, 31.9539, 8_000_000);
...
/** Apply CartoDB Dark Matter imagery to the viewer */
function applyOSM(viewer: CesiumViewer) {
  ...
  const darkProvider = new UrlTemplateImageryProvider({
    ...
    minimumLevel: 0,
    maximumLevel: 19,
    credit: new Credit('© <a href="https://carto.com">CartoDB</a> © <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'),
  });
