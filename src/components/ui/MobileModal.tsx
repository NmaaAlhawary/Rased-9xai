...
export default function MobileModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex flex-col bg-wv-black/95 backdrop-blur-md">
      {/* Header bar */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-wv-border shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[12px] text-wv-text font-semibold font-sora">
            {title}
          </span>
        </div>
        <button
          ...
          className="w-8 h-8 flex items-center justify-center rounded-xl
                     text-wv-muted hover:text-wv-text hover:bg-white/8
